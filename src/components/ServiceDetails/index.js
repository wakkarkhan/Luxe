            ...
            <div className="service-details-left">
              <div className="sidebar-widget">
                <ul className="service-menu">
                  <li>
                    <Link to="/service-single">{t("rental_tourist")}</Link>
                  </li>
                  <li>
                    <Link to="/service-single">{t("rental_organizations")}</Link>
                  </li>
                  <li >
                    <Link to="/service-single">{t("rental_embassy")}</Link>
                  </li>
                  <li className="active">
                    <Link to="/service-single">{t("rental_wedding")}</Link>
                  </li>
                  <li>
                    <Link to="/service-single">{t("private_tour_guide")}</Link>
                  </li>
                  <li>
                    <Link to="/service-single">{t("guest")}</Link>
                  </li>
                </ul>
              </div>
              {/* <div className="sidebar-widget">
